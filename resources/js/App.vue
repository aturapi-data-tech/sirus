            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="http://localhost:1313/" class="flex ml-2 md:mr-24">
                        <img src="http://localhost:1313/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo">
                        <span
                ...
                <div class="flex items-center">
                    ...
                    <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(892px, 6354px);"
                        ...
                        <div>
                            <a href="#"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="rounded-full w-11 h-11"
                                        src="http://localhost:1313/images/users/bonnie-green.png" alt="Jese image">
                                    <div
                            ...
                            <a href="#"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="rounded-full w-11 h-11"
                                        src="http://localhost:1313/images/users/jese-leos.png" alt="Jese image">
                                    <div
                            ...
                            <a href="#"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="rounded-full w-11 h-11"
                                        src="http://localhost:1313/images/users/joseph-mcfall.png" alt="Joseph image">
                                    <div
                            ...
                            <a href="#"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="rounded-full w-11 h-11"
                                        src="http://localhost:1313/images/users/leslie-livingston.png" alt="Leslie image">
                                    <div
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <div class="flex-shrink-0">
                                    <img class="rounded-full w-11 h-11"
                                        src="http://localhost:1313/images/users/robert-brown.png" alt="Robert image">
                                    <div
                    ...
                    <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                        id="apps-dropdown"
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(932px, 6354px);"
                        data-popper-placement="bottom">
                        <div
                            class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Apps
                    ...
                    <div id="tooltip-toggle" role="tooltip"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1195px, 63px);"
                        data-popper-placement="bottom">
                        Toggle dark mode
                    ...
                    <div class="flex items-center ml-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            id="dropdown-2"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1020px, 6350px);"
                            data-popper-placement="bottom">
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <aside id="sidebar"
            ...
            <div
                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                                    <li>
                                        <a href="http://localhost:1313/layouts/stacked/"
                                    ...
                                    <li>
                                        <a href="http://localhost:1313/layouts/sidebar/"
                ...
                <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
                    ...
                    <a href="http://localhost:1313/settings/" data-tooltip-target="tooltip-settings"
                        class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z"
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 6939px);"
                        data-popper-placement="bottom">
                        <ul class="py-1" role="none">
                            <li>
                                <a href="#"
        ...
        <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
                            ...
                            <div class="items-center sm:flex">
                                <div class="flex items-center">
                                    ...
                                    <div id="dropdown"
                                        ...
                                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(536px, 5928px);"
                        ...
                        <div class="flex items-center justify-between pt-3 sm:pt-6">
                            <div>
                                ...
                                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                                    ...
                                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(355px, 6687px);"
                                    data-popper-placement="bottom">
                                    <div class="px-4 py-3" role="none">
            ...
            <p class="my-10 text-sm text-center text-gray-500">
               Aturapi Data Technology © 2019-2023 <a href="https://flowbite.com/" class="hover:underline" target="_blank">Flowbite.com</a>. All
                rights reserved.
            </p>
