            ...
            <div>
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" src="http://localhost:1313/images/users/bonnie-green.png"
                    alt="Jese image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" src="http://localhost:1313/images/users/jese-leos.png"
                    alt="Jese image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" src="http://localhost:1313/images/users/joseph-mcfall.png"
                    alt="Joseph image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" src="http://localhost:1313/images/users/leslie-livingston.png"
                    alt="Leslie image">
                  <div
              ...
              <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                <div class="flex-shrink-0">
                  <img class="rounded-full w-11 h-11" src="http://localhost:1313/images/users/robert-brown.png"
                    alt="Robert image">
                  <div
