import {
  axios_default
} from "./chunk-WZWZ2RD2.js";
import "./chunk-NVUDSZEQ.js";
import {
  require_lodash,
  require_lodash2
} from "./chunk-2K7NL5HT.js";
import {
  createSSRApp,
  defineComponent,
  h,
  ...
  shallowRef,
  watch
} from "./chunk-LTKDDV3C.js";
import {
  require_cjs,
  require_lib
} from "./chunk-GSXKK5UO.js";
import {
  __commonJS,
  __toESM
...
function k(t, e, i, n = "brackets") {
  let o = /^https?:\/\//.test(e.toString()), c = o || e.toString().startsWith("/"), h3 = !c && !e.toString().startsWith("#") && !e.toString().startsWith("?"), m2 = e.toString().includes("?") || t === "get" && Object.keys(i).length, b2 = e.toString().includes("#"), a = new URL(e.toString(), "http://localhost");
  return t === "get" && Object.keys(i).length && (a.search = O.stringify((0, import_deepmerge.default)(O.parse(a.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[o ? `${a.protocol}//${a.host}` : "", c ? a.pathname : "", h3 ? a.pathname.substring(1) : "", m2 ? a.search : "", b2 ? a.hash : ""].join(""), i];
}
function w(t) {
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h3 = false, only: m2 = [], headers: b2 = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
  }, onBefore: L2 = () => {
  }, onStart: d = () => {
  }, onProgress: p = () => {
  }, onFinish: T2 = () => {
    ...
    let P = { url: x, method: i, data: n, replace: o, preserveScroll: c, preserveState: h3, only: m2, headers: b2, errorBag: a, forceFormData: l, queryStringArrayFormat: F, cancelled: false, completed: false, interrupted: false };
    if (L2(P) === false || !M(P))
      return;
    this.activeVisit && this.cancelVisit(this.activeVisit, { interrupted: true }), this.saveScrollPositions();
    let G2 = this.createVisitId();
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L2, onStart: d, onProgress: p, onFinish: T2, onCancel: y, onSuccess: D2, onError: U, queryStringArrayFormat: F, cancelToken: new AbortController() }, g({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
    } }), W(P), d(P), axios_default({ method: i, url: w(x).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...b2, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...m2.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": m2.join(",") } : {}, ...a && a.length ? { "X-Inertia-Error-Bag": a } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
      ...
      let s = r.data;
      m2.length && s.component === this.page.component && (s.props = { ...this.page.props, ...s.props }), c = this.resolvePreserveOption(c, s), h3 = this.resolvePreserveOption(h3, s), h3 && ((_a = window.history.state) == null ? void 0 : _a.rememberedState) && s.component === this.page.component && (s.rememberedState = window.history.state.rememberedState);
      let E2 = x, V = v(s.url);
      return E2.hash && !V.hash && w(E2).href === V.href && (V.hash = E2.hash, s.url = V.href), this.setPage(s, { visitId: G2, replace: o, preserveScroll: c, preserveState: h3 });
    }).then(() => {
  ...
  setPage(e, { visitId: i = this.createVisitId(), replace: n = false, preserveScroll: o = false, preserveState: c = false } = {}) {
    return Promise.resolve(this.resolveComponent(e.component)).then((h3) => {
      i === this.visitId && (e.scrollRegions = e.scrollRegions || [], e.rememberedState = e.rememberedState || {}, n = n || v(e.url).href === window.location.href, n ? this.replaceState(e) : this.pushState(e), this.swapComponent({ component: h3, page: e, preserveState: c }).then(() => {
...
function Q(t, e, i) {
  ...
  return a(), { forceUpdate: a, createProvider: function() {
    let l = c();
    return { update: (g) => m2(l, g), disconnect: () => h3(l) };
  } };
}
var Y = null;
function ne(t) {
...
var _2 = L;
function v2(e, o) {
  let n = typeof e == "string" ? e : null, p = typeof e == "string" ? o : e, t = n ? Oe.restore(n) : null, a = typeof p == "object" ? (0, import_lodash2.default)(p) : (0, import_lodash2.default)(p()), l = null, f2 = null, d = (r) => r, g = reactive({ ...t ? t.data : (0, import_lodash2.default)(a), isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let c = d(this.data()), y = { ...i, onCancelToken: (u2) => {
      ...
      let O2 = i.onSuccess ? await i.onSuccess(u2) : null;
      return a = (0, import_lodash2.default)(this.data()), this.isDirty = false, O2;
    }, onError: (u2) => {
    ...
    r === "delete" ? Oe.delete(s, { ...y, data: c }) : Oe[r](s, c, y);
  }, get(r, s) {
    this.submit("get", r, s);
  }, post(r, s) {
  ...
  return watch(g, (r) => {
    g.isDirty = !(0, import_lodash3.default)(g.data(), a), n && Oe.remember((0, import_lodash2.default)(r.__remember()), n);
  }, { immediate: true, deep: true }), g;
}
var m = ref(null);
var b = ref(null);
...
var N2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  m.value = o ? markRaw(o) : null, b.value = e, T.value = null;
  let a = typeof window > "u";
  return k2 = Q(a, p, t), a || (Oe.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    m.value = markRaw(l.component), b.value = l.page, T.value = l.preserveState ? T.value : Date.now();
  } }), Oe.on("navigate", () => k2.forceUpdate())), () => {
    if (m.value) {
      m.value.inheritAttrs = !!m.value.inheritAttrs;
      let l = h(m.value, { ...b.value.props, key: T.value });
      return C2.value && (m.value.layout = C2.value, C2.value = null), m.value.layout ? typeof m.value.layout == "function" ? m.value.layout(h, l) : (Array.isArray(m.value.layout) ? m.value.layout : [m.value.layout]).concat(l).reverse().reduce((f2, d) => (d.inheritAttrs = !!d.inheritAttrs, h(d, { ...b.value.props }, () => f2))) : l;
    }
  };
} });
var E = N2;
...
async function $2({ id: e = "app", resolve: o, setup: n, title: p, progress: t = {}, page: a, render: l }) {
  let f2 = typeof window > "u", d = f2 ? null : document.getElementById(e), g = a || JSON.parse(d.dataset.page), r = (c) => Promise.resolve(o(c)).then((y) => y.default || y), s = [], i = await r(g.component).then((c) => n({ el: d, App: E, props: { initialPage: g, initialComponent: c, resolveComponent: r, titleCallback: p, onHeadUpdate: f2 ? (y) => s = y : null }, plugin: I2 }));
  if (!f2 && t && Z(t), f2) {
    let c = await l(createSSRApp({ render: () => h("div", { id: e, "data-page": JSON.stringify(g), innerHTML: i ? l(i) : "" }) }));
    return { head: s, body: c };
  }
}
var z2 = defineComponent({ props: { title: { type: String, required: false } }, data() {
